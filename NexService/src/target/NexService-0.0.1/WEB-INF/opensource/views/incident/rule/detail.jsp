...
$(function(){
	new Client().url("/api/v1/rule/ruleset/targetsystem").callback(appendTargetSystem).getNotCluster();
	...
	if( "${idx}" != "" )
	{
		...
		new Client().url("/api/v1/rule/${idx}").callback(getRulesetData).getNotCluster();
