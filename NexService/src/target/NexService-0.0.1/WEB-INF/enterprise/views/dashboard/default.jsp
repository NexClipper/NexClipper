				...
				<div class="col-lg-2">
					<div class="m-portlet m-portlet--head-sm m-portlet--full-height ">
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									<div class="m-portlet__head-text"><a class = "titleA" href="/kubernetes/daemonset">Daemon Sets</a></div>
								</div>
							</div>
							<div class="m-portlet__head-tools"></div>
						</div>
						<div class="m-portlet__body">
							<div class="m-widget14" style="height: 40px; text-align: center;">
								<div class="m-widget14__chart">
									<div class="m-widget14__stat">
										<a href="/kubernetes/daemonset" class="btn-link m--font-metal">
				...
				<div class="col-lg-2">
					<div class="m-portlet m-portlet--head-sm m-portlet--full-height ">
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									<div class="m-portlet__head-text"><a class = "titleA" href="/kubernetes/deployment">Deployments</a></div>
								</div>
							</div>
							<div class="m-portlet__head-tools"></div>
						</div>
						<div class="m-portlet__body">
							<div class="m-widget14" style="height: 40px; text-align: center;">
								<div class="m-widget14__chart">
									<div class="m-widget14__stat">
										<a href="/kubernetes/deployment" class="btn-link m--font-metal">
				...
				<div class="col-lg-2">
					<div class="m-portlet m-portlet--head-sm m-portlet--full-height ">
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									<div class="m-portlet__head-text"><a class = "titleA" href="/kubernetes/replicaset">Replica Sets</a></div>
								</div>
							</div>
							<div class="m-portlet__head-tools"></div>
						</div>
						<div class="m-portlet__body">
							<div class="m-widget14" style="height: 40px; text-align: center;">
								<div class="m-widget14__chart">
									<div class="m-widget14__stat">
										<a href="/kubernetes/replicaset" class="btn-link m--font-metal">
				...
				<div class="col-lg-2">
					<div class="m-portlet m-portlet--head-sm m-portlet--full-height ">
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									<div class="m-portlet__head-text"><a class = "titleA" href="/kubernetes/statefulset">Stateful Sets</a></div>
								</div>
							</div>
							<div class="m-portlet__head-tools"></div>
						</div>
						<div class="m-portlet__body">
							<div class="m-widget14" style="height: 40px; text-align: center;">
								<div class="m-widget14__chart">
									<div class="m-widget14__stat">
										<a href="/kubernetes/statefulset" class="btn-link m--font-metal">
				...
				<div class="col-lg-2">
					<div class="m-portlet m-portlet--head-sm m-portlet--full-height ">
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									<div class="m-portlet__head-text"><a class = "titleA" href="/agent/default">NexClipper Agent</a></div>
								</div>
							</div>
							<div class="m-portlet__head-tools"></div>
						</div>
						<div class="m-portlet__body">
							<div class="m-widget14" style="height: 40px; text-align: center;">
								<div class="m-widget14__chart">
									<div class="m-widget14__stat">
										<a href="/agent/default" class="btn-link m--font-metal">
