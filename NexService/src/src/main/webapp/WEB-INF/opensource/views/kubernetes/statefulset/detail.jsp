...
var statefulsetName = "${statefulsetName}";
var START_TIME = "1h";
var TIME = "5s";
...
function drawStatefulset (data) {
	...
	data.items.forEach(function(item){
		if (statefulsetName == item.metadata.name)
			thisStatefulset = item;
	})
	if (typeof thisStatefulset != "undefined")
		drawStatefulsetInfo(thisStatefulset);
}
...
function drawStatefulsetInfo (data) {
