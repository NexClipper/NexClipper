...
{
	private static K8SConsumer thisObj 	= null;
	static final Logger 	logger 		= LoggerFactory.getLogger(K8SConsumer.class);
	
	private KafkaConsumer<String, String> consumer = null;
	
	public synchronized static K8SConsumer getInstance(){
		if ( thisObj == null ){
			logger.debug("Kafka Consumer!!!!!!!!!!!!!!!");
			try {
				thisObj = new K8SConsumer();
