...
static final Logger logger = LoggerFactory.getLogger(RedisCluster.class);
	...
	public synchronized void put( String key, String field, String data)
    {
		...
		try{
			...
			logger.error("Redis Put Exception : "+(System.currentTimeMillis() - actor_start));
			if( jedis != null ){
				jedis.close();
			}
		}
    ...
    public synchronized String get( String key, String field)
    {
    	...
    	try{
    		...
    		logger.error("Redis Get Exception : "+(System.currentTimeMillis() - actor_start));
    		if( jedis != null ){
    			jedis.close();
    		}
		}
    ...
    public synchronized void remove( String key, String field)
    {
    	...
    	try{
    		...
    		logger.error("Redis Remove Exception : "+(System.currentTimeMillis() - actor_start));
    		if( jedis != null ){
    			jedis.close();
    		}
    	}
